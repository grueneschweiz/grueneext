<div id="grueneext-short-code-generator" style="display: none;">
	<div class="wrapper">
		...
		<form action="#" method="post">
			<p id="grueneext-select-type">
               ...
               <div id="grueneext-short-code-hide_n_show" class="grueneext-short-code-type-element">
                    <p id="grueneext-select-hide_n_show" class="grueneext-short-code-input">
                         <label for="grueneext-hide_n_show-display"><?php _e( 'Enter the title of your hide and show element', 'grueneext' ); ?></label><br/>
                         <input type="text" name="grueneext-hide_n_show-display" placeholder="<?php esc_attr_e( 'Enter your "Hide and Show" title here.', 'grueneext' ); ?>" >
                    </p>
               </div>
               ...
               <div id="grueneext-short-code-button" class="grueneext-short-code-type-element">
                    <p id="grueneext-select-button-link" class="grueneext-short-code-input">
                         <label for="grueneext-button-link"><?php _e( 'Enter the link where the button leads to', 'grueneext' ); ?></label><br/>
                         <input type="url" name="grueneext-button-link" placeholder="<?php esc_attr_e( 'Where shall the button lead to (URL)?', 'grueneext' ); ?>" >
                    </p>
               ...
               <div id="grueneext-short-code-progressbar" class="grueneext-short-code-type-element">
                    <p id="grueneext-select-progressbar-max" class="grueneext-short-code-input">
                         <label for="grueneext-progressbar-max"><?php _e( 'Enter the maximum value.', 'grueneext' ); ?></label><br/>
                    ...
                    <p id="grueneext-select-progressbar-value" class="grueneext-short-code-input">
                         <label for="grueneext-progressbar-value"><?php _e( 'Enter the current value.', 'grueneext' ); ?></label><br/>
                    ...
                    <p id="grueneext-select-progressbar-unit" class="grueneext-short-code-input">
                         <label for="grueneext-progressbar-unit"><?php _e( 'Enter the unit (optional).', 'grueneext' ); ?></label><br/>
                    ...
                    <p id="grueneext-select-progressbar-show_value" class="grueneext-short-code-input">
                         <label for="grueneext-progressbar-show_value"><?php _e( 'Choose if the value should be displayed', 'grueneext' ); ?></label><br/>
                    ...
                    <p id="grueneext-select-progressbar-color" class="grueneext-short-code-input">
                         <label for="grueneext-progressbar-color"><?php _e( 'Chose color scheme', 'grueneext' ); ?></label><br/>
			...
			<input id="grueneext-submit-short-code" type="submit" value="<?php esc_attr_e( 'Insert shortcode', 'grueneext' ); ?>" class="button button-primary button-large">
		</form>
	</div>
</div>
